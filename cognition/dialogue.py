...
The exchange is bounded at L_max rounds (default: 2 in combat, 4 in
pre-battle). Each response is generated by a single LLM call.
...
def _emit_dialogue_memories(
    ...
    Also emits "overheard" observations for nearby agents.
    """
        ...
        for other in env.alive_agents():
            ...
            if other_pos:
                ...
                if dist <= env.perception_engine.perception_radius:
                    ...
                    # Store in their memory if cognitive loop has their state
                    # (will be handled by the cognitive loop)
